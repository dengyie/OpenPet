...
} = require('../windows/pet-context-menu')
const { showPetContextMenuWindow } = require('../windows/pet-context-menu-window')
const { createBubbleRequestId } = require('../windows/pet-bubble-chat-window')
const { createLocalHttpToken } = require('../services/local-http-service')
const { registerAiIpc } = require('./register-ai-ipc')
const { registerCreatorIpc } = require('./register-creator-ipc')
const { registerPetRuntimeIpc } = require('./register-pet-runtime-ipc')
const { registerPluginIpc } = require('./register-plugin-ipc')
const { registerSettingsIpc } = require('./register-settings-ipc')
const { registerServiceIpc } = require('./register-service-ipc')
const { registerSystemIpc } = require('./register-system-ipc')
const { createPetChatFacade } = require('./pet-chat-facade')
const { createActionsSidecarBridge } = require('./actions-sidecar-bridge')
const {
...
} = require('../services/control-center-adapters')
