...
const PET_CHAT_ENTRY_PATH = path.join(projectRoot, 'apps', 'desktop', 'src', 'windows', 'pet-chat', 'index.html')
...
const createPetChatWindowManager = ({
  ...
  const open = () => {
    ...
    chatWindow = new BrowserWindow({
      ...
      webPreferences: {
        preload: path.join(projectRoot, 'apps', 'desktop', 'src', 'windows', 'pet-chat-preload.js'),
