...
const PET_BUBBLE_CHAT_ENTRY_PATH = path.join(projectRoot, 'apps', 'desktop', 'src', 'windows', 'pet-bubble-chat', 'index.html')
...
const createPetBubbleChatWindowManager = ({
  ...
  const ensureWindow = () => {
    ...
    bubbleWindow = new BrowserWindow({
      ...
      webPreferences: {
        preload: path.join(projectRoot, 'apps', 'desktop', 'src', 'windows', 'pet-bubble-chat-preload.js'),
