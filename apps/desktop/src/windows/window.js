...
const PET_ENTRY_PATH = path.join(projectRoot, 'apps', 'desktop', 'index.html')
...
const createWindow = ({ load = true, BrowserWindow = electron.BrowserWindow, screen = electron.screen } = {}) => {
  const petWindow = new BrowserWindow({
    ...
    webPreferences: {
      preload: path.join(projectRoot, 'apps', 'desktop', 'preload.js'),
...
const createSettingsWindow = (petWindow, { BrowserWindow = electron.BrowserWindow, screen = electron.screen, app = electron.app } = {}) => {
  ...
  const settingsWindow = new BrowserWindow({
    ...
    webPreferences: {
      preload: path.join(projectRoot, 'apps', 'desktop', 'control-center-preload.js'),
      contextIsolation: true,
      nodeIntegration: false
    }
  })
