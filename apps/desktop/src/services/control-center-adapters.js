...
/**
 * @typedef {import('../shared/openpet-contracts.ts').BlocklistState} BlocklistState
 * @typedef {import('../shared/openpet-contracts.ts').CatalogBlocklistResult} CatalogBlocklistResult
 * @typedef {import('../shared/openpet-contracts.ts').CatalogState} CatalogState
 * @typedef {import('../shared/openpet-contracts.ts').LocalHttpConfigViewState} LocalHttpConfigViewState
 * @typedef {import('../shared/openpet-contracts.ts').LocalHttpRuntimeViewState} LocalHttpRuntimeViewState
 * @typedef {import('../shared/openpet-contracts.ts').ServiceLogEntry} ServiceLogEntry
 * @typedef {import('../shared/openpet-contracts.ts').ServiceStatusViewState} ServiceStatusViewState
 * @typedef {import('../shared/openpet-contracts.ts').PluginMutationResult} PluginMutationResult
 * @typedef {import('../shared/openpet-contracts.ts').PluginCommandRunResultViewState} PluginCommandRunResultViewState
 * @typedef {import('../shared/openpet-contracts.ts').PluginConfigFieldViewState} PluginConfigFieldViewState
 * @typedef {import('../shared/openpet-contracts.ts').PluginConfigSchemaViewState} PluginConfigSchemaViewState
 * @typedef {import('../shared/openpet-contracts.ts').PluginCommandViewState} PluginCommandViewState
 * @typedef {import('../shared/openpet-contracts.ts').PluginCommandEntryViewState} PluginCommandEntryViewState
 * @typedef {import('../shared/openpet-contracts.ts').PluginSetupRuntimeViewState} PluginSetupRuntimeViewState
 * @typedef {import('../shared/openpet-contracts.ts').PluginSetupEntryViewState} PluginSetupEntryViewState
 * @typedef {import('../shared/openpet-contracts.ts').PluginSetupRunResultViewState} PluginSetupRunResultViewState
 * @typedef {import('../shared/openpet-contracts.ts').PluginDashboardEntryViewState} PluginDashboardEntryViewState
 * @typedef {import('../shared/openpet-contracts.ts').PluginServiceHealthPolicyViewState} PluginServiceHealthPolicyViewState
 * @typedef {import('../shared/openpet-contracts.ts').PluginServiceRuntimeViewState} PluginServiceRuntimeViewState
 * @typedef {import('../shared/openpet-contracts.ts').PluginServiceHealthViewState} PluginServiceHealthViewState
 * @typedef {import('../shared/openpet-contracts.ts').PluginServiceControlResult} PluginServiceControlResult
 * @typedef {import('../shared/openpet-contracts.ts').PluginServiceHealthCheckResult} PluginServiceHealthCheckResult
 * @typedef {import('../shared/openpet-contracts.ts').PluginViewState} PluginViewState
 * @typedef {import('../shared/openpet-contracts.ts').ActionFrameImportResult} ActionFrameImportResult
 * @typedef {import('../shared/openpet-contracts.ts').ActionsMutationResult} ActionsMutationResult
 * @typedef {import('../shared/openpet-contracts.ts').ActionsConfigViewState} ActionsConfigViewState
 * @typedef {import('../shared/openpet-contracts.ts').AboutInfoViewState} AboutInfoViewState
 * @typedef {import('../shared/openpet-contracts.ts').AboutUpdateInfo} AboutUpdateInfo
 * @typedef {import('../shared/openpet-contracts.ts').AiBehaviorConfig} AiBehaviorConfig
 * @typedef {import('../shared/openpet-contracts.ts').AiBehaviorDecision} AiBehaviorDecision
 * @typedef {import('../shared/openpet-contracts.ts').AiBehaviorResult} AiBehaviorResult
 * @typedef {import('../shared/openpet-contracts.ts').PetPackMutationResult} PetPackMutationResult
 * @typedef {import('../shared/openpet-contracts.ts').PetPacksViewState} PetPacksViewState
 * @typedef {import('../shared/openpet-contracts.ts').UpdateCheckViewState} UpdateCheckViewState
 */
...
const { sanitizePluginCommandText } = require('./plugin-runtime-safety')
 ...
 * @returns {import('../shared/openpet-contracts.ts').JsonValue | undefined}
 */
...
/**
 * @param {unknown} value
 * @returns {import('../shared/openpet-contracts.ts').JsonValue[]}
 */
...
/**
 * @param {unknown} value
 * @returns {import('../shared/openpet-contracts.ts').JsonObject}
 */
 ...
 * @returns {import('../shared/openpet-contracts.ts').ActionTriggerRuleSpec}
 */
 ...
 * @returns {import('../shared/openpet-contracts.ts').AiConfigViewState}
 */
...
/**
 * @param {unknown} value
 * @returns {import('../shared/openpet-contracts.ts').AiBehaviorIntent | null}
 */
 ...
 * @returns {{ reply: string, behaviorIntent: import('../shared/openpet-contracts.ts').AiBehaviorIntent | null }}
 */
 ...
 * @param {unknown} rule
 * @param {number} index
 * @returns {import('../shared/openpet-contracts.ts').AiBehaviorRule | null}
 */
...
/**
 * @param {import('../shared/openpet-contracts.ts').AiBehaviorRule | null} rule
 * @returns {rule is import('../shared/openpet-contracts.ts').AiBehaviorRule}
 */
 ...
 * @returns {import('../shared/openpet-contracts.ts').ProviderModelCatalogViewState}
 */
 ...
 * @returns {import('../shared/openpet-contracts.ts').AiPersona}
 */
...
/**
 * @param {unknown} persona
 * @returns {import('../shared/openpet-contracts.ts').AiPersonaOverride}
 */
 ...
 * @returns {import('../shared/openpet-contracts.ts').AiPersonaProfileViewState}
 */
...
/**
 * @param {unknown} draft
 * @returns {import('../shared/openpet-contracts.ts').AiPersonaDraftViewState}
 */
 ...
 * @returns {import('../shared/openpet-contracts.ts').AiMemoryItemViewState}
 */
...
/**
 * @param {unknown} job
 * @returns {import('../shared/openpet-contracts.ts').AiMemoryJobViewState}
 */
...
/**
 * @param {unknown} profile
 * @returns {import('../shared/openpet-contracts.ts').AiMemoryProfileViewState}
 */
...
/**
 * @param {unknown} config
 * @returns {import('../shared/openpet-contracts.ts').ImageGenerationConfigViewState}
 */
...
/**
 * @param {unknown} result
 * @returns {import('../shared/openpet-contracts.ts').ImageGenerationSaveApiKeyResult}
 */
...
/**
 * @param {unknown} result
 * @returns {import('../shared/openpet-contracts.ts').ImageGenerationHealthCheckResult}
 */
 ...
 * @returns {import('../shared/openpet-contracts.ts').CatalogReviewState | undefined}
 */
 ...
 * @returns {import('../shared/openpet-contracts.ts').CatalogPluginEntry}
 */
 ...
 * @returns {import('../shared/openpet-contracts.ts').CatalogPetPackEntry}
 */
 ...
 * @param {{ defaultStatus?: import('../shared/openpet-contracts.ts').PluginServiceHealthStatus }} [options]
...
const createPluginServiceHealthView = (health = {}, options = {}) => {
  ...
  const view = {
    status: typeof input.status === 'string' && PLUGIN_SERVICE_HEALTH_STATUSES.has(input.status)
      ? /** @type {import('../shared/openpet-contracts.ts').PluginServiceHealthStatus} */ (input.status)
      : defaultStatus,
 ...
 * @returns {import('../shared/openpet-contracts.ts').PluginServiceEntryViewState | null}
 */
...
/**
 * @param {import('../shared/openpet-contracts.ts').PluginServiceEntryViewState | null} service
 * @returns {service is import('../shared/openpet-contracts.ts').PluginServiceEntryViewState}
 */
 ...
 * @returns {import('../shared/openpet-contracts.ts').PluginStorageViewState}
 */
 ...
 * @returns {import('../shared/openpet-contracts.ts').PluginSignatureStatusViewState}
 */
...
/**
 * @param {unknown} blockStatus
 * @returns {import('../shared/openpet-contracts.ts').PetPackSummary['blockStatus']}
 */
...
/**
 * @param {unknown} atlas
 * @returns {import('../shared/openpet-contracts.ts').SpriteAtlas | undefined}
 */
 ...
 * @returns {import('../shared/openpet-contracts.ts').PetPackPreviewAction | null}
 */
 ...
 * @returns {import('../shared/openpet-contracts.ts').PetPackProvenance | undefined}
 */
 ...
 * @returns {import('../shared/openpet-contracts.ts').PetPackVersionConflict | undefined}
 */
...
/**
 * @param {unknown} pack
 * @returns {import('../shared/openpet-contracts.ts').PetPackSummary}
 */
...
/**
 * @param {unknown} frame
 * @returns {import('../shared/openpet-contracts.ts').ActionFrameInfo | null}
 */
...
/**
 * @param {import('../shared/openpet-contracts.ts').ActionFrameInfo | null} frame
 * @returns {frame is import('../shared/openpet-contracts.ts').ActionFrameInfo}
 */
const isActionFrameInfoView = (frame) => Boolean(frame)

/**
 * @param {unknown} inspection
 * @returns {import('../shared/openpet-contracts.ts').ActionFrameInspection}
 */
 ...
 * @returns {import('../shared/openpet-contracts.ts').ActionFrameInspectionResult}
 */
...
/**
 * @param {Partial<import('../shared/openpet-contracts.ts').ActionTriggerProposalAcceptanceResult>} proposal
 * @returns {import('../shared/openpet-contracts.ts').ActionTriggerProposalAcceptanceResult}
 */
...
/**
 * @param {Partial<import('../shared/openpet-contracts.ts').ActionTriggerRule>} rule
 * @returns {import('../shared/openpet-contracts.ts').ActionTriggerRule}
 */
...
/**
 * @param {Partial<import('../shared/openpet-contracts.ts').ActionTriggerProposalInboxItem>} proposal
 * @returns {import('../shared/openpet-contracts.ts').ActionTriggerProposalInboxItem}
 */
...
/**
 * @param {Partial<import('../shared/openpet-contracts.ts').ActionTriggerProposalPreviewResult>} proposal
 * @returns {import('../shared/openpet-contracts.ts').ActionTriggerProposalPreviewResult}
 */
 ...
 * @param {Partial<{
 *   proposal: Partial<import('../shared/openpet-contracts.ts').ActionTriggerProposalInboxItem>,
 *   triggerProposal: Partial<import('../shared/openpet-contracts.ts').ActionTriggerProposalAcceptanceResult>
 * }> | undefined} [result]
...
/**
 * @param {Partial<import('../shared/openpet-contracts.ts').UpdateAssetViewState> | undefined} asset
 * @returns {import('../shared/openpet-contracts.ts').UpdateAssetViewState}
 */
...
const createUpdateCheckView = (result = {}) => ({
  ...
  assets: Array.isArray(result.assets)
    ? /** @type {import('../shared/openpet-contracts.ts').UpdateAssetViewState[]} */ (result.assets.map((asset) => createUpdateAssetView(asset || {})))
    : [],
