...
const { getLegacyPetAnimations, loadLegacyPetPack, loadPetPackFromDirectory } = require('../pet/pet-pack/loader')
const { normalizePetPackManifest } = require('../pet/pet-pack/schema')
