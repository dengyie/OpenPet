...
import type { HatchPetAgentConfigView } from '../../../../desktop/src/shared/openpet-contracts.ts';
import type { ControlCenterApi, AiChatRequest, AiChatResponse, AiConfigViewState, AiPersonaProfileViewState, AiMemoryProfileViewState, AiBehaviorConfig, AiTalkTraceSummaryViewState, AiPersonaDraftViewState, AiBehaviorResult, AiConnectionTestResult, ProviderModelDiscoveryResult } from '../../../../desktop/src/shared/openpet-contracts.ts';
