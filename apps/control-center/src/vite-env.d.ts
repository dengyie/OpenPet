...
interface OpenPetSecretStorageSecurity {
...
interface Window {
  openpetBackend?: {
    ...
    getSecretStorageSecurity?: () => OpenPetSecretStorageSecurity | null
    onSecretStorageSecurityChanged?: (listener: (state: OpenPetSecretStorageSecurity | null) => void) => () => void
  }
}
