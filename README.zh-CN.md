...
建议先看已经纳入测试的 [Focus Timer 示例插件](./examples/plugins/focus-timer/)，再读完整 [插件开发文档](./docs/plugin-development.md)。
...
项目使用 **Node 原生 test runner** 覆盖 service / release / IPC / 示例插件路径，当前 **262 个测试全部通过**；同时维护 **Playwright Control Center UI 回归基线**，当前 9 个 UI 测试通过。
...
- ✅ Focus Timer 示例插件通过真实本地插件服务覆盖 inspect / install / run
