...
项目使用 **Node 原生 test runner** 覆盖 service / release / IPC 路径，当前 **238 个测试全部通过**；同时维护 **Playwright Control Center UI 回归基线**，当前 9 个 UI 测试通过。
...
测试覆盖：
- ✅ Service / release / IPC 门禁覆盖（33 个测试文件）
...
- ⚡ Windows 签名产物验证与冒烟验证
- ⚡ 已启动 packaged app 中的 Electron 原生 OS 文件选择器验证
- ⚡ 更多示例插件（天气、番茄钟、RSS）
- ⚡ 插件开发教程视频
- ⚡ 用户反馈收集与迭代
