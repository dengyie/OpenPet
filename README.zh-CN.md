...
[![Tests](https://img.shields.io/badge/tests-236%20node%20%2B%209%20ui-success)](./tests)
...
项目使用 **Node 原生 test runner** 覆盖 service / release 路径，当前 **236 个测试全部通过**；同时维护 **Playwright Control Center UI 回归基线**，当前 9 个 UI 测试通过。
...
- ⚡ Windows 签名产物验证与冒烟验证
- ⚡ Electron 宿主下的原生文件选择器与真实插件包校验冒烟验证
- ⚡ 更多示例插件（天气、番茄钟、RSS）
- ⚡ 插件开发教程视频
- ⚡ 用户反馈收集与迭代
