...
test('createRcUpgradeSmokeReport emits a ready report when legacy data is seeded and observed', () => {
  ...
  assert.equal(report.environment.appDataDir, 'app-data')
  assert.equal(report.environment.legacyUserDataDir, 'app-data/ibot')
  assert.equal(report.environment.currentUserDataDir, 'app-data/OpenPet')
  assert.equal(report.environment.observedUserDataDir, 'app-data/ibot')
  assert.equal(report.fixture.settings, 'app-data/ibot/settings.json')
  assert.equal(report.fixture.secrets, 'app-data/ibot/secrets.json')
  ...
  assert.equal(report.checks.find((check) => check.id === 'legacy-dir-exists').evidence, 'app-data/ibot')
  assert.equal(report.checks.find((check) => check.id === 'settings-preserved').evidence, 'app-data/ibot/settings.json')
  assert.equal(report.checks.find((check) => check.id === 'secrets-preserved').evidence, 'app-data/ibot/secrets.json')
