...
[![Tests](https://img.shields.io/badge/tests-181%20passed-success)](./tests)
...
- 🚀 **Desktop Release Track** - macOS release baseline; Windows packaging/CI/signing-policy/smoke-evidence-gate baseline with release-readiness gates still open
...
- **Node.js**: >= 18.x
- **npm**: >= 9.x
- **OS**: macOS validated; Windows packaging/CI/signing-policy/smoke-evidence-gate baseline implemented but not release-ready; Linux/mobile are out of the current release scope
...
The project uses **Node native test runner** with **181 tests all passing**.
...
Test Coverage:
- ✅ Full service/release coverage (25 test files)
