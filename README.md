...
[![Tests](https://img.shields.io/badge/tests-186%20passed-success)](./tests)
...
- 🚀 **Desktop Release Track** - macOS release baseline; Windows packaging/CI/signing-policy/smoke-evidence/reporting baseline with release-readiness gates still open
...
- **Node.js**: >= 18.x
- **npm**: >= 9.x
- **OS**: macOS validated; Windows packaging/CI/signing-policy/smoke-evidence/reporting baseline implemented but not release-ready; Linux/mobile are out of the current release scope
...
npm test                     # Run all tests (186 tests)
...
The project uses **Node native test runner** with **186 tests all passing**.
...
Test Coverage:
- ✅ Full service/release coverage (26 test files)
