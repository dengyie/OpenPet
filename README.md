...
[![Tests](https://img.shields.io/badge/tests-226%20passed-success)](./tests)
...
- 🚀 **Desktop Release Track** - macOS release baseline; Windows packaging/CI/signing-policy/smoke-evidence/reporting/runbook/collector/bundle-validation/summary tooling baseline with release-readiness gates still open
...
- **Node.js**: >= 18.x
- **npm**: >= 9.x
- **OS**: macOS validated; Windows packaging/CI/signing-policy/smoke-evidence/reporting/runbook/collector/bundle-validation/summary tooling baseline implemented but not release-ready; Linux/mobile are out of the current release scope
...
npm test                     # Run all tests (226 tests)
...
The project uses **Node native test runner** with **226 tests all passing**.
...
Test Coverage:
- ✅ Full service/release coverage (31 test files)
