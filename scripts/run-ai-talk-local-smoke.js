...
const { createPetUtteranceLogService } = require('../apps/desktop/src/services/pet-utterance-log-service')
...
const { createPetBubbleChatWindowManager, createBubbleRequestId } = require('../apps/desktop/src/windows/pet-bubble-chat-window')
