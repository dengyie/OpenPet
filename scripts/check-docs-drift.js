...
const createChecks = (docsRoot) => {
  ...
  return [
    ...
    },
    {
      ...
      run: () => /release-evidence\/.*ai-provider-smoke\/.*ai-talk-local-smoke\/.*agent-awareness-local-smoke\/.*creator-studio-provider-smoke\/.*packaged-runtime\/.*signed-release-closure\//is.test(readme),
