...
const { createBasicBehaviorPlugin } = require('../apps/desktop/src/services/plugins/official/basic-behavior')
const { getLegacyPetAnimations } = require('../apps/desktop/src/pet/pet-pack/loader')
