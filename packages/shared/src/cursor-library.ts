import type { ControlCenterSettings, CustomCursorRecord, CustomCursorScope, CustomCursorSettings, CursorOption } from './openpet-contracts.ts'
...
const normalizeHiddenCursorIds = (_hiddenCursorIds: unknown): string[] => []

export const normalizeCustomCursorScope = (value: unknown): CustomCursorScope => value === 'system' ? 'system' : 'openpet'
...
export const createPersistedCursorRecord = (
  cursor: Partial<CursorOption> | null | undefined
...
): Pick<ControlCenterSettings, 'selectedCursorId' | 'customCursors' | 'customCursor' | 'hiddenCursorIds' | 'customCursorScope'> => {
