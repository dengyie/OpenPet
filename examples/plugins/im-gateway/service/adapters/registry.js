...
const createDefaultAdapters = ({ config, token, secrets, wecomSecrets = {}, httpClient, websocketFactory, now, logEvent } = {}) => [
  ...
  createWecomAdapter({ config, secrets: wecomSecrets, logEvent, httpClient })
]
