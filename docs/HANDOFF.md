...
> Last updated: 2026-06-18 | Branch: `codex/plugin-cleanup-evidence-archive-phase89`
...
21. Use Phase 89 plugin cleanup evidence archive manifests as the current cleanup-evidence archive boundary: maintainers can hash and validate report, collector, and collected evidence directories while keeping archive validity separate from cleanup readiness.
22. After Phase 89, continue from collecting real signed workflow artifacts, live external community submission evidence, packaged cleanup evidence execution, or another high-drift service/report boundary.
