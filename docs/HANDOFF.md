...
> Last updated: 2026-06-18 | Branch: `codex/phase99-live-community-plugin-submission`
...
- `docs/plugin-development.md`, `docs/plugin-ecosystem-rules.md`, and `docs/plugin-submission-workflow-playbook.md` for extension onboarding, maintainer approval rehearsal, remote-source rehearsal, community-source evidence, and legacy SDK compatibility.
- `scripts/create-openpet-plugin.js`, `scripts/create-plugin-author-rehearsal.js`, `scripts/create-plugin-real-world-submission-rehearsal.js`, `scripts/create-plugin-remote-source-submission-rehearsal.js`, `scripts/create-plugin-community-source-submission-evidence.js`, `scripts/create-plugin-maintainer-approval.js`, and `scripts/validate-plugin-maintainer-approval.js` for current compatibility starter templates, existing-plugin rehearsal, remote-source rehearsal, community-source evidence, and reviewer-path rehearsal.
...
31. After Phase 99, continue from collecting real signed workflow artifacts, a live independent community source run through the new evidence command, or another high-drift service/report boundary.
