...
6. Keep the completed IM adapter path under regression review. `origin/main@ab0ec234` is pushed and remote CI run [33697412974](https://github.com/dengyie/OpenPet/actions/runs/33697412974) succeeded. Simulated protocol tests are development gates; real Telegram/QQ/WeCom account smoke is manual `not-run` evidence and is not a current test-version development completion gate.
