...
> Last updated: 2026-06-28 | Release track: `v1.0.1-rc.3`
...
2. [`docs/jishuwendang.md`](./jishuwendang.md)
3. [`docs/project-context.json`](./project-context.json)
4. [`docs/project-status-review.md`](./project-status-review.md)
5. [`docs/openpet-current-todo-architecture.md`](./openpet-current-todo-architecture.md)
6. [`docs/productization-v1.1-todo-design.md`](./productization-v1.1-todo-design.md)
7. [`docs/project-documentation-design.md`](./project-documentation-design.md)
...
- Action trigger proposals are review inputs, not plugin-owned mutations. The host can currently apply `click` proposals to `clickAction`, acknowledge `manual`/`unbound`, queue Creator Studio approved-import proposals into the persistent inbox with source provenance, and must keep `random`/`state`/`event` pending until a host trigger-rule editor/schema exists.
