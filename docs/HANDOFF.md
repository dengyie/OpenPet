...
3. Use Phase 51 Pet pack mutation Control Center adapter work as the current TypeScript migration baseline.
4. After Phase 51, start the next concrete phase from a fresh review or from real evidence work: signed release evidence, Windows smoke evidence, native picker evidence, community plugin rehearsal, About/update adapters, or the next high-drift service boundary.
