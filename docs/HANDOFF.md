...
3. Use Phase 50 plugin mutation Control Center adapter work as the current TypeScript migration baseline.
4. After Phase 50, start the next concrete phase from a fresh review or from real evidence work: signed release evidence, Windows smoke evidence, native picker evidence, community plugin rehearsal, pet pack/About adapters, or the next high-drift service boundary.
