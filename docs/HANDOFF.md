...
3. Use Phase 52 About/update Control Center adapter work as the current TypeScript migration baseline.
4. After Phase 52, start the next concrete phase from a fresh review or from real evidence work: signed release evidence, Windows smoke evidence, native picker evidence, community plugin rehearsal, or the next high-drift service boundary.
