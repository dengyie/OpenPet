...
| 扩展作者体验 | 已有 legacy SDK runner、示例、校验、审核包、PR/workflow 工具、developer-first local extension 文档边界、`entries.commands` compatibility runtime 支持，以及显式 HTTP/HTTPS dashboard opening | runtime 补齐 shell command execution、service lifecycle、setup、health、bridge 与第三方提交演练 |
