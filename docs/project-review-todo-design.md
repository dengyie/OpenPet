...
| 扩展作者体验 | 已有 legacy SDK runner、示例、校验、审核包、PR/workflow 工具、developer-first local extension 文档边界、`entries.commands` compatibility runtime 支持、显式 HTTP/HTTPS dashboard opening，以及显式 service start/stop | runtime 继续补齐 setup、health、bridge、通用 shell command execution、进程树清理与第三方提交演练 |
