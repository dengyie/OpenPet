...
```bash
npm run update-desktop-picker-smoke-report -- docs/release-evidence/desktop-picker/2026-07-06T16-46-49Z-win32-x64-authenticated-artifact-archive-rerun/desktop-picker-smoke-report.json --check packaged-launch --status pass --evidence "<real evidence>"
```
...
```bash
npm run update-desktop-picker-smoke-report -- docs/release-evidence/desktop-picker/2026-07-06T16-46-49Z-win32-x64-authenticated-artifact-archive-rerun/desktop-picker-smoke-report.json --check control-center-open --status pass --evidence "<real evidence>"
```
...
```bash
npm run update-desktop-picker-smoke-report -- docs/release-evidence/desktop-picker/2026-07-06T16-46-49Z-win32-x64-authenticated-artifact-archive-rerun/desktop-picker-smoke-report.json --check plugin-picker-cancel --status pass --evidence "<real evidence>"
```
...
```bash
npm run update-desktop-picker-smoke-report -- docs/release-evidence/desktop-picker/2026-07-06T16-46-49Z-win32-x64-authenticated-artifact-archive-rerun/desktop-picker-smoke-report.json --check plugin-picker-zip-review --status pass --evidence "<real evidence>"
```
...
```bash
npm run update-desktop-picker-smoke-report -- docs/release-evidence/desktop-picker/2026-07-06T16-46-49Z-win32-x64-authenticated-artifact-archive-rerun/desktop-picker-smoke-report.json --check plugin-install-disabled --status pass --evidence "<real evidence>"
```
...
```bash
npm run update-desktop-picker-smoke-report -- docs/release-evidence/desktop-picker/2026-07-06T16-46-49Z-win32-x64-authenticated-artifact-archive-rerun/desktop-picker-smoke-report.json --check invalid-package-feedback --status pass --evidence "<real evidence>"
```
...
```bash
npm run update-desktop-picker-smoke-report -- docs/release-evidence/desktop-picker/2026-07-06T16-46-49Z-win32-x64-authenticated-artifact-archive-rerun/desktop-picker-smoke-report.json --check action-frame-picker-cancel --status pass --evidence "<real evidence>"
```
...
```bash
npm run update-desktop-picker-smoke-report -- docs/release-evidence/desktop-picker/2026-07-06T16-46-49Z-win32-x64-authenticated-artifact-archive-rerun/desktop-picker-smoke-report.json --check pet-pack-picker-cancel --status pass --evidence "<real evidence>"
```
...
```bash
npm run update-desktop-picker-smoke-report -- docs/release-evidence/desktop-picker/2026-07-06T16-46-49Z-win32-x64-authenticated-artifact-archive-rerun/desktop-picker-smoke-report.json --check state-after-picker-smoke --status pass --evidence "<real evidence>"
```
...
```bash
npm run validate-desktop-picker-smoke-report -- docs/release-evidence/desktop-picker/2026-07-06T16-46-49Z-win32-x64-authenticated-artifact-archive-rerun/desktop-picker-smoke-report.json
npm run validate-desktop-picker-smoke-report -- docs/release-evidence/desktop-picker/2026-07-06T16-46-49Z-win32-x64-authenticated-artifact-archive-rerun/desktop-picker-smoke-report.json --require-signed
```
