...
Generated: 2026-07-03T15:38:33.000Z
...
| Poller diagnostics | pass | `seenCount = 1355`, `unsupportedLifecycleRecordCount = 19`, `lastError = ""`. |

## Sample Sessions

| Session | Status | Project | Events |
| --- | --- | --- | --- |
| `c769bb02d6f5` | `working` | `OpenPet #262c94` | 71 |
| `04863673f289` | `completed` | `OpenPet #834bd8` | 68 |
| `e2b6e7df2708` | `working` | `OpenPet #586229` | 62 |
| `16b03e6e8010` | `failed` | `OpenPet #586229` | 60 |
| `a61ca1ca52e9` | `completed` | `OpenPet #00d409` | 65 |
...
node scripts/create-agent-awareness-local-smoke-archive.js --session-dir agent-awareness-local-smoke/2026-07-03T15-38-32-999Z --archive-dir docs/release-evidence/agent-awareness-local-smoke/2026-07-03T15-38-32-999Z
