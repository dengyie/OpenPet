...
Generated: 2026-06-16T15:37:18.706Z
...
- Archive manifest: windowsSmokeReport: artifact.authenticodeEvidence is required when --require-signed is used
- Archive manifest: missing desktopPickerReport: /Users/mango/project/codex/OpenPet/docs/release-evidence/signed-release-closure/2026-06-16T15-00-00Z/desktop-picker-smoke-report.json
...
- Archive manifest: missing macosCodesignEvidence: /Users/mango/project/codex/OpenPet/docs/release-evidence/signed-release-closure/2026-06-16T15-00-00Z/macos-codesign.txt
- Archive manifest: missing macosNotarizationEvidence: /Users/mango/project/codex/OpenPet/docs/release-evidence/signed-release-closure/2026-06-16T15-00-00Z/macos-notarization.txt
- Archive manifest: missing macosGatekeeperEvidence: /Users/mango/project/codex/OpenPet/docs/release-evidence/signed-release-closure/2026-06-16T15-00-00Z/macos-gatekeeper.txt
- Archive manifest releaseReady is false
- macOS codesign evidence is missing
- macOS notarization evidence is missing
- macOS Gatekeeper evidence is missing
...
- Windows smoke evidence: artifact.authenticodeEvidence is required when --require-signed is used
- Windows smoke evidence: artifact.version evidence is required
...
- Windows smoke evidence: windowsSmokeReport: artifact.authenticodeEvidence is required when --require-signed is used
- Windows desktop picker evidence is missing
- Windows packaged runtime evidence is for darwin, not win32
- Windows packaged runtime evidence: artifact.signed must be true when --require-signed is used
- Windows packaged runtime evidence: artifact.signatureStatus must be "Valid" for signed macOS runtime smoke readiness
- Windows packaged runtime evidence: plugin-picker-evidence-linked must pass before packaged runtime smoke readiness can be claimed
- Windows packaged runtime evidence: pet-picker-evidence-linked must pass before packaged runtime smoke readiness can be claimed
- Windows packaged runtime evidence: invalid-package-feedback must pass before packaged runtime smoke readiness can be claimed
- Windows packaged runtime evidence: packagedRuntimeReport: artifact.signed must be true when --require-signed is used
- Windows packaged runtime evidence: packagedRuntimeReport: artifact.signatureStatus must be "Valid" for signed macOS runtime smoke readiness
...
- Capture signed Windows Authenticode, clean-machine smoke, desktop picker, and packaged runtime evidence.
