...
> v1.4 · 2026-09-04 · 基线分支 `main` · T37 仓库现状复核
...
`BACKEND_TO_SHELL_TYPES` 与契约 `backendToShellSchema` 均为 9 项,包含 `dialog.request`;请求复用 envelope `id`,结果超时为 60 秒。缺口 G2 已关闭(证据见 §4)。
