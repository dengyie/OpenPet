# OpenPet 前后端分离 · 开发文档 v1.1

> 📌 **状态** 架构决策已全部定案,待开工 · **版本** v1.1 · **代码基线** `dengyie/OpenPet@c56a3f1` (main / v1.0.1-rc.3) · **编写日期** 2026-08-09
...
| ADR-003 | PetService 位置 | 保留在 Electron 主进程 | 仅 3.8 KB 纯状态机,被窗口/菜单/气泡三处同步依赖,跨进程会导致动画抖动 |
