...
| Node 原生 test runner | — | Service / release / IPC / example plugin / plugin submission / RC upgrade smoke / desktop picker evidence 测试框架（300 个测试） |
...
**质量指标**：
- ✅ 300/300 Node 测试通过（service / release / 示例插件 / 插件提交校验、审核包、PR packet、workflow bundle 与 bundle validation、RC upgrade smoke 门禁覆盖）
