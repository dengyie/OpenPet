...
| Node 原生 test runner | — | Service / release / IPC / example plugin / plugin submission / sandbox evaluation / RC upgrade smoke / Codex pet import / Codex pet zip import / bundled Codex pets / pet pack export / AI behavior diagnostics / TypeScript migration gate / desktop picker evidence / packaged runtime evidence 测试框架（390 个测试） |
...
**质量指标**：
- ✅ 390/390 Node 测试通过（service / release / 示例插件 / 插件提交校验、审核包、PR packet、workflow bundle 与 bundle validation、plugin sandbox evaluation、RC upgrade smoke、Codex pet import、Codex pet zip import、bundled Codex pets、pet pack export、AI behavior diagnostics、TypeScript migration gate 门禁覆盖）
