...
| Node 原生 test runner | — | Service / release / IPC / example plugin / plugin submission / desktop picker evidence 测试框架（269 个测试） |
...
**质量指标**：
- ✅ 269/269 Node 测试通过（service / release / 示例插件 / 插件提交校验门禁覆盖）
...
- ✅ 39 个测试文件（恶意输入、示例插件、插件提交校验、主进程 IPC 与 release 证据门禁/报告生成/填写/runbook、collector、证据包校验、summary、archive-manifest 与 desktop picker smoke evidence 工具测试完整）
