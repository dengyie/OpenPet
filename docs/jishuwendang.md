...
| Node 原生 test runner | — | Service / release / IPC / example plugin / desktop picker evidence 测试框架（262 个测试） |
...
**质量指标**：
- ✅ 262/262 Node 测试通过（service / release / 示例插件门禁覆盖）
