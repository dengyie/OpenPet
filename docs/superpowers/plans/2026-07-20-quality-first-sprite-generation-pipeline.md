...
- [ ] **Step 2: Run `node --test tests/examples/creator-studio-sprite-asset-plan.test.js tests/examples/creator-studio-action-semantics.test.js tests/examples/creator-studio-action-sheet-layout.test.js` and verify RED**

- [ ] **Step 3: Implement frozen plan and code-owned presets**
