...
- 插件生态已有示例资产、提交前校验入口和 reviewer 审核包入口，但真实第三方提交流程、教程和社区运营还未闭环。
...
- 示例插件 install/run。
- 插件提交前 package validation CLI 与 reviewer submission report CLI。
- 主进程插件包 IPC。
