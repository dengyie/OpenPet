...
| Renderer contract hardening | [`renderer-contract-checklist.md`](./renderer-contract-checklist.md), [`src/main/control-center-adapters.js`](../src/main/control-center-adapters.js), [`src/control-center/src/lib/defaults.ts`](../src/control-center/src/lib/defaults.ts) |
